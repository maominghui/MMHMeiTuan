//
//  MMHDiscountWebViewController.m
//  MMHMeiTuan
//
...
@interface MMHDiscountWebViewController ()<UIWebViewDelegate>
{
    
    UIActivityIndicatorView *_activityView;//加载
}
@end

@implementation MMHDiscountWebViewController
