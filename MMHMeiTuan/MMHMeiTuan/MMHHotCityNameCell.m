...
@implementation MMHHotCityNameCell
...
+(instancetype)cellWithTableView:(UITableView *)tableView hotCityArray:(NSArray *)hotCityArray{
    static NSString *cellIndentifier = @"MMHHotCityNameCell";
    MMHHotCityNameCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIndentifier];
    if (cell == nil) {
        cell = [[MMHHotCityNameCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier];
